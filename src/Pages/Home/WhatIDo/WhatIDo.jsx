        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          >
            ...
            <h1 className="text-5xl font-bold">
              We help organize events for kids
            </h1>
          ...
          <div className="grid items-center grid-cols-1 gap-10 mt-12 md:grid-cols-5 sm:gap-y-16">
            <div>
              <img
                ...
                src="https://i.postimg.cc/8PKhnGNt/cl5-copyright.png"
                alt=""
              />
            </div>
            <div>
              <img
                className="object-contain w-auto mx-auto h-14"
                src="https://i.postimg.cc/cCD8j7yr/cl4-copyright.png"
                alt=""
              />
            </div>
            ...
            <div>
              <img
                ...
                src="https://i.postimg.cc/2SgnrxqW/cl3-copyright.png"
                alt=""
              />
            </div>
            ...
            <div>
              <img
                ...
                src="https://i.postimg.cc/YSgY9mgs/cl2-copyright.png"
                alt=""
              />
            </div>
            ...
            <div>
              <img
                className="object-contain w-full mx-auto h-14"
                src="https://i.postimg.cc/nhXqyWLZ/cl1-copyright.png"
                alt=""
              />
            </div>
          </div>
